...
public class ViewListaFactura extends javax.swing.JFrame {
    ...
    public ViewListaFactura() {
        ...
        DefaultTableModel model =(DefaultTableModel) this.TablaCand.getModel();
    ...
    private void initComponents() {
        ...
        TablaCand = new javax.swing.JTable();
        ...
        TablaCand.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(TablaCand);
        if (TablaCand.getColumnModel().getColumnCount() > 0) {
            TablaCand.getColumnModel().getColumn(0).setMinWidth(50);
            TablaCand.getColumnModel().getColumn(0).setPreferredWidth(50);
            TablaCand.getColumnModel().getColumn(0).setMaxWidth(50);
            TablaCand.getColumnModel().getColumn(1).setMinWidth(50);
            TablaCand.getColumnModel().getColumn(1).setPreferredWidth(50);
            TablaCand.getColumnModel().getColumn(1).setMaxWidth(50);
            TablaCand.getColumnModel().getColumn(2).setResizable(false);
            TablaCand.getColumnModel().getColumn(3).setMinWidth(120);
            TablaCand.getColumnModel().getColumn(3).setPreferredWidth(120);
            TablaCand.getColumnModel().getColumn(3).setMaxWidth(120);
            TablaCand.getColumnModel().getColumn(4).setMinWidth(300);
            TablaCand.getColumnModel().getColumn(4).setPreferredWidth(300);
            TablaCand.getColumnModel().getColumn(4).setMaxWidth(300);
        }
    ...
    public javax.swing.JTable TablaCand;
