...
public class ClienteControlador {
    ...
    public ClienteControlador() {
       ...
       public void  crear(ViewCliente  vcli){
        ...
        cli.setNit(Integer.parseInt(vcli.txtNit.getText()));
       ...
       public Cliente traer(int nit){
           Cliente ActualCliente = (Cliente)regCliente.traer(nit);
           return ActualCliente;
     } 
       public boolean ExisteId(int Id){
           return !regCliente.contiene(Id);
